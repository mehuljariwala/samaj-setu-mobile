import type { AstrologyProvider } from '../types/astrology';
import type { BirthDetails } from '../types/birth';
import type { Kundli } from '../types/kundli';
import { getBasicKundli, getExtendedKundli } from './navamshaClient';
import { normalizeKundli } from './kundliNormalizer';
