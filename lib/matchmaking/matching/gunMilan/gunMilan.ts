import type { GunaMilanResult } from '../../types/compatibility';
import type { Kundli } from '../../types/kundli';
import { calculateVarna } from './varna';
import { calculateVashya } from './vashya';
import { calculateTaraKoota } from './tara';
import { calculateYoni } from './yoni';
import { calculateGrahaMaitri } from './grahaMaitri';
import { calculateGanaKoota } from './gana';
import { calculateBhakoot } from './bhakoot';
import { calculateNadi } from './nadi';
import { getNakshatraByName, getNakshatraByIndex } from '../../constants/nakshatras';
import { getRashiByName, getRashiByIndex } from '../../constants/rashis';
