...
import type { CompatibilityResult, OverallScore, FactorExplanation } from '../../types/compatibility';
import type { Kundli } from '../../types/kundli';
import { getEnv } from '@/lib/matchmaking/config';
import { WEIGHTS } from './weights';
import { calculateGunaMilan } from '../gunMilan/gunMilan';
import { calculateRashiCompatibility } from '../rashi';
import { calculateNakshatraCompatibility } from '../nakshatra';
import { calculateGotraCompatibility } from '../gotra';
import { calculateManglik } from '../manglik';
import { calculateGanaKoota } from '../gunMilan/gana';
import {
  calculateEmotional,
...
import { weightedAverage } from '../../utils/numbers';
