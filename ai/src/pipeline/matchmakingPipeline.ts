import type { PersonInput } from '../types/birth.js';
import type { CompatibilityResult } from '../types/compatibility.js';
import type { AIReport } from '../types/aiReport.js';
import { runKundliPipeline } from './kundliPipeline.js';
import { runMatchEngine } from '../matching/scoring/scoreCalculator.js';
import { OpenRouterProvider, buildFallbackReport } from '../ai/OpenRouterProvider.js';
import { buildAIInput } from '../types/aiReport.js';
import { matchRepository, reportRepository } from '../database/client.js';
