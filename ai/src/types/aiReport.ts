import type { CompatibilityResult, GunaMilanResult, CompatibilityFactor, CompatibilityScore, ManglikResult, OverallScore, FactorExplanation } from './compatibility.js';
