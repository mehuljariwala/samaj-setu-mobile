import type { CompatibilityScore } from '../types/compatibility.js';
import type { Kundli } from '../types/kundli.js';
import { getPlanet, getPlanetsInHouse } from '../types/kundli.js';
import { getPlanetRelationship } from '../constants/planets.js';
import { ELEMENT_COMPATIBILITY } from '../constants/astrology.js';
