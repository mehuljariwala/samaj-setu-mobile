...
import { calculateGotraCompatibility } from '@/lib/matchmaking/matching/gotra';
import { calculateManglik } from '@/lib/matchmaking/matching/manglik';
import { calculateRashiCompatibility } from '@/lib/matchmaking/matching/rashi';
import { RASHIS } from '@/lib/matchmaking/constants/rashis';
import { NAKSHATRAS } from '@/lib/matchmaking/constants/nakshatras';
...
describe('Manglik Detection', () => {
  ...
  it('marks compatible when both are Manglik', () => {
    ...
    // Optional on the type, so assert it was populated rather than assuming it.
    expect(result.cancellationFactors).toBeDefined();
